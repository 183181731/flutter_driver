...
mixin CommandHandlerFactory {
  ...
  Future<Result> _drag(Command command, WidgetController prober) async {
    final Drag dragCommand = command as Drag;
    final Offset startLocation =
        Offset(dragCommand.start_x, dragCommand.start_y);
    final Offset offset = Offset(dragCommand.offset_x, dragCommand.offset_y);
