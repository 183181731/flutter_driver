...
class ByTooltipMessage extends SerializableFinder {
  ...
  static ByTooltipMessage deserialize(Map<String, String> json) {
    return ByTooltipMessage(
        json['text']!, json.containsKey('index') ? json['index']! : "-1");
  }
}
...
class BySemanticsLabel extends SerializableFinder {
  ...
  static BySemanticsLabel deserialize(Map<String, String> json) {
    ...
    return BySemanticsLabel(isRegExp ? RegExp(json['label']!) : json['label']!,
        json.containsKey('index') ? json['index']! : "-1");
  }
}
...
class ByValueKey extends SerializableFinder {
  ...
  static ByValueKey deserialize(Map<String, String> json) {
    ...
    switch (keyValueType) {
      ...
      case 'String':
        return ByValueKey(
            keyValueString, json.containsKey('index') ? json['index']! : "-1");
      default:
...
class ByType extends SerializableFinder {
  ...
  static ByType deserialize(Map<String, String> json) {
    return ByType(
        json['type']!, json.containsKey('index') ? json['index']! : "-1");
  }
}
...
class GetElementCount extends CommandWithTarget {
  /// Creates a command which to count the Widget match by finder.
  GetElementCount(super.finder, {super.timeout});

  /// Creates a command from a JSON map.
  GetElementCount.deserialize(super.json, super.finderFactory)
      : super.deserialize();

  @override
  String get kind => 'get_element_count';
}

/// The result of a [GetElementCount] command.
class GetElementCountResult extends Result {
  /// Creates a new [GetElementCount] result.
  const GetElementCountResult(this.count);

  /// The element count of the element finder list.
  final int count;

  /// Deserializes this result from JSON.
  static GetElementCountResult fromJson(Map<String, dynamic> json) {
    return GetElementCountResult(json['count'] as int);
  }
