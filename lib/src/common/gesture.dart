...
class Drag extends Command {
  const Drag(
      this.start_x, this.start_y, this.offset_x, this.offset_y, this.duration,
      {super.timeout});

  Drag.deserialize(super.json)
      : start_x = double.parse(json['start_x']!),
        start_y = double.parse(json['start_y']!),
        offset_x = double.parse(json['offset_x']!),
        offset_y = double.parse(json['offset_y']!),
